...
public partial class PRN222_EYEWEARSHOPContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ColorTriChid).HasName("PK__ProductC__B9231320FFDE6D72");

            entity.ToTable("ProductColorTriCH");

            entity.Property(e => e.ColorTriChid).HasColumnName("colorTriCHId");
            ...
            entity.HasOne(d => d.ProductTriCh).WithMany(p => p.ProductColorTriChes)
                .HasForeignKey(d => d.ProductTriChid)
        ...
        {
            entity.HasKey(e => e.ImageTriChid).HasName("PK__ProductI__735D786AF90B2077");

            entity.ToTable("ProductImageTriCH");

            entity.Property(e => e.ImageTriChid).HasColumnName("imageTriCHId");
            entity.Property(e => e.ColorTriChid).HasColumnName("colorTriCHId");
            ...
            entity.HasOne(d => d.ColorTriCh).WithMany(p => p.ProductImageTriChes)
                .HasForeignKey(d => d.ColorTriChid)
                .HasConstraintName("FK_ProductImage_ProductColor");

            entity.HasOne(d => d.ProductTriCh).WithMany(p => p.ProductImageTriChes)
                .HasForeignKey(d => d.ProductTriChid)
